...
class ScoreSystem {
    ...
    rank() {
        ...
        return ranks; // sorting된 rank배열 return
    }
}
...
fs.readFile('./data/score.csv', "utf8", (err, data) => {
    ...
    module.exports.scoreSystem = new ScoreSystem(scoreInfo);
...
module.exports.ljh = new Score("10,이준희,85,70,90") //testing을 위한 이준희 Score module.exports